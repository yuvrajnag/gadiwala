    ...
    const handleBookNow = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Go immediately to booked interface. WebSocket will handle driver found event.
                navigate('/booked-interface', { state: { rideId: data.id } });
            } else {
            ...
            alert('Ride creation failed due to network error.');
            setIsBooking(false);
        }
    };
