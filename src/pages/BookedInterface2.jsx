...
const BookedInterface2 = () => {
    ...
    useEffect(() => {
        ...
        const loadContent = async () => {
            ...
            if (!rideError && rideData) {
                ...
                if (rideData.passenger_email) {
                    const pData = await fetchFullProfile(rideData.passenger_email);
        ...
        const pollInterval = setInterval(async () => {
            if (ride?.passenger_email && !passenger) {
                console.log('Polling fallback: checking passenger profile again...');
                const pData = await fetchFullProfile(ride.passenger_email);
                if (pData) setPassenger(pData);
            }
        }, 5000);
    ...
    }, [rideId, navigate, ride?.passenger_email, passenger]);
